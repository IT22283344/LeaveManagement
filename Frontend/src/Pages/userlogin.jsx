...
export default function UserSignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/dashboard?tab=staffprofile");
    } catch (error) {
  ...
  return (
    ...
    >
      <div className="w-1/2 pr-10 hidden lg:flex items-center justify-center">
        <img
      ...
      <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-5">
          ...
          <Button
            className="bg-slate-500 disabled={loading} text-white hover:bg-gray-800"
            type="submit"
          >
            {loading ? (
              <>
        ...
        <div className="text-blue-400 flex justify-end mt-5">
         <Link to={'/userlogin'}><span  className="cursor-pointer">ADMIN Login</span></Link> 
        </div>
