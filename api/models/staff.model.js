...
const staffSchema = new mongoose.Schema(
  {
    ...
    departmentname: {
      type: String,
      required: true,
      enum: ["IT", "HRM", "SALES", "OPERATION", "RESEARCH"],
    },
